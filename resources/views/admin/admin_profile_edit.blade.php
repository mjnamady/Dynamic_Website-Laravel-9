                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.profile.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" src="{{ (!empty($editData->profile_image))? url('uploads/admin_images/'.$editData->profile_image) : url('uploads/no_image.jpg') }}" alt="avatar-5" class="rounded avatar-lg">
                                </div>
                            </div>
                            <!-- end row -->
